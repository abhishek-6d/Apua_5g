...
public class HiberanteUtilBiuser 
{
	private static Logger logger = Logger.getLogger(HiberanteUtilBiuser.class);
	...
	private static SessionFactory getbuildSessionFactory()
	{
		try
		{
			...
			{
				configFile = "hibernate_Biuser.cfg.xml";
				logger.info("******************************* Oracle DB is loading ... .... ******************************* ");
				
			}
			else
			{
				configFile = "Mysql_hibernate_Biuser.cfg.xml";
