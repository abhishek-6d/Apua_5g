...
public class HiberanteUtilProfile 
{
	private static Logger logger = Logger.getLogger(HiberanteUtilProfile.class);
	...
	private static SessionFactory getbuildSessionFactory()
	{
		try
		{
			...
			{
				configFile = "hibernate_Profile.cfg.xml";
				logger.info("******************************* Oracle DB is loading ... .... ******************************* ");
				
			}
			else
			{
				configFile = "Mysql_hibernate_Profile.cfg.xml";
