...
public class UserAuthenticationRespAssm extends RespAssmGUICommon {
	/**
	...
	public GenericDTO buildAssembleGUIResp(GenericDTO genericDTO) throws CommonException {
		...
		UserAuthenticationDTO userDTO=(UserAuthenticationDTO) genericDTO.getObj();
		
			ResponseDTO respDTO=new ResponseDTO();
			respDTO.setStatusCode(userDTO.getStatusCode());
			respDTO.setStatusDescription(userDTO.getStatusDesc());		
			logger.info("genericDTO.setStatusCode"+respDTO.getStatusCode());
			logger.info("genericDTO.setStatus"+respDTO.getStatusDescription());
