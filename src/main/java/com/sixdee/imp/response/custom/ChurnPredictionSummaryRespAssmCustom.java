...
public class ChurnPredictionSummaryRespAssmCustom extends RespAssmCustom {
	...
	public GenericDTO endAssembleRespCustom(GenericDTO genericDTO) throws CommonException {
		logger.info("Class => ChurnPredictionSummaryRespAssmCustom :: Method => endAssembleRespCustom()");
		return genericDTO;
	}
