...
public class GetOfferCodeOnMarketingPlanRespAssmCustom extends RespAssmCustom {
	...
	public GenericDTO endAssembleRespCustom(GenericDTO genericDTO) throws CommonException {
		logger.info("Class => GetOfferCodeOnMarketingPlanRespAssmCustom :: Method => endAssembleRespCustom()");
		return genericDTO;
	}
