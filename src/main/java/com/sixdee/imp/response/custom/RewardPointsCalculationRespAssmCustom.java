...
public class RewardPointsCalculationRespAssmCustom extends RespAssmCustom {
	...
	public GenericDTO endAssembleRespCustom(GenericDTO genericDTO) throws CommonException {
		logger.info("Class => RewardPointsCalculationRespAssmCustom :: Method => endAssembleRespCustom()");
		return genericDTO;
	}
