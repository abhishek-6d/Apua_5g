...
public class SubscriberTransactionHistoryRespAssmCustom extends RespAssmCustom {
	...
	public GenericDTO endAssembleRespCustom(GenericDTO genericDTO) throws CommonException {
		logger.info("Class => SubscriberTransactionHistoryRespAssmCustom :: Method => endAssembleRespCustom()");
		return genericDTO;
	}
