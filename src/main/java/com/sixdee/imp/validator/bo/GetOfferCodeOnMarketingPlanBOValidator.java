...
public class GetOfferCodeOnMarketingPlanBOValidator extends BOValidatorCommon {
	...
	public GenericDTO buildValidate(GenericDTO genericDTO) throws CommonException {
		logger.info("Class => GetOfferCodeOnMarketingPlanBOValidator :: Method => buildValidate()");
