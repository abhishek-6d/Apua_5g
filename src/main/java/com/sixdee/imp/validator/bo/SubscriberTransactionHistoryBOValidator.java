...
public class SubscriberTransactionHistoryBOValidator extends BOValidatorCommon {
	...
	public GenericDTO buildValidate(GenericDTO genericDTO) throws CommonException {
		logger.info("Class => SubscriberTransactionHistoryBOValidator :: Method => buildValidate()");
