...
public class DeleteAccountFrmtValidatorCustom extends FrmtValidatorCustom {
	...
	public GenericDTO startValidateCustom(GenericDTO genericDTO)
			throws CommonException {
		 logger.info("Class => GUILoginFrmtValidatorCustom :: Method => startValidateCustom()");
		return genericDTO;
	}
	...
	public GenericDTO endValidateCustom(GenericDTO genericDTO)
			throws CommonException {
		logger.info("Class => GUILoginFrmtValidatorCustom :: Method => endValidateCustom()");
		return genericDTO;
	}
