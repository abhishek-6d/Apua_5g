...
public class MgmntAddServiceJars {
	...
	public static void main(String arg[])throws Exception{
		...
		if (arg.length == 0 || arg.length<4) {
			System.err.println("Usage: java -jar SingMgmnt.jar MgmntAddServiceJars IpAddress Port LoginName LoginPassword jarName");
			return;
		}
		...
		MgmntAddServiceJars ad=new MgmntAddServiceJars();
	...
	public String getAllCommandString(String requestParam) {
		...
		String allCommandString = "<REQ><CMD>addnewservices</CMD><PARAMETERS>"
