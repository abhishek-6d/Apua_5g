...
public class MgmntDynLoadQueue {
	...
	public static void main(String arg[])throws Exception{
		...
		if (arg.length == 0 || arg.length<4) {
			System.err.println("Usage: java -jar MgmntClient.jar QueueLoad IpAddress Port LoginName LoginPassword");
			return;
		}
		...
		MgmntDynLoadQueue ad=new MgmntDynLoadQueue();
	...
	public String getAllCommandString(String requestParam) {
		...
		String allCommandString = "<REQ><CMD>QueueLoad</CMD><PARAMETERS>"
