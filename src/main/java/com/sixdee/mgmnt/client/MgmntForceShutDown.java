...
public class MgmntForceShutDown {
	...
	public static void main(String arg[])throws Exception{
		...
		if (arg.length == 0 || arg.length<4) {
			System.err.println("Usage: java -jar MgmntClient.jar MgmntForceShutDown IpAddress Port LoginName LoginPassword");
			return;
		}
		...
		MgmntForceShutDown ad=new MgmntForceShutDown();
	...
	public String getAllCommandString() {
		...
		String allCommandString = "<REQ><CMD>ForceShutDown</CMD><PARAMETERS></PARAMETERS></REQ>";
