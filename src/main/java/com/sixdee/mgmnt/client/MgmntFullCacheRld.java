...
public class MgmntFullCacheRld {
	...
	public static void main(String arg[])throws Exception{
		...
		if (arg.length == 0 || arg.length<4) {
			System.err.println("Usage: java -jar MgmntClient.jar MgmntFullCacheRld IpAddress Port LoginName LoginPassword");
			return;
		}
		...
		MgmntFullCacheRld ad=new MgmntFullCacheRld();
	...
	public String getAllCommandString() {
		...
		String allCommandString = "<REQ><CMD>FullCacheReload</CMD><PARAMETERS></PARAMETERS></REQ>";
