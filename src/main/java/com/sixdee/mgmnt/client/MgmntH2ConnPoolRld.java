...
public class MgmntH2ConnPoolRld {
	...
	public static void main(String arg[])throws Exception{
		...
		if (arg.length == 0 || arg.length<4) {
			System.err.println("Usage: java -jar MgmntClient.jar MgmntH2ConnPoolRld IpAddress Port LoginName LoginPassword");
			return;
		}
		...
		MgmntH2ConnPoolRld ad=new MgmntH2ConnPoolRld();
	...
	public String getAllCommandString() {
		...
		String allCommandString = "<REQ><CMD>RelaodH2ConnPool</CMD><PARAMETERS></PARAMETERS></REQ>";
