 ...
 * </p>
 */
public class SimpleAuthenticationCall implements WSCallInter {

	private Logger logger = Logger.getLogger(SimpleAuthenticationCall.class);
	...
	public UssdResponseDTO callService(ServiceRequestDTO serviceRequestDTO,
		...
		try{
			...
			logger.info("Simple Authentication Call ");			
